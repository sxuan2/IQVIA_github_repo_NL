# -*- coding: utf-8 -*-
"""
Created on Thu Jul 19 15:00:56 2018
...
"""
    ...
    approach to the AUC. 
    - The multi_a_value() function is the probabilistic approximation
    of the AUC found in equation 3
    - The multi_auc() is the pairwise averaging of this value for each of the classes. 
    - Note that this program correponds to Equation 7 in their paper.
"""
import itertools

def multi_a_value(probabilities, zero_label=0, one_label=1):
    """
...
def multi_auc(data, num_classes):
    """
    ...
    for pairing in class_pairs:
        sum_avals += (multi_a_value(data, zero_label=pairing[0], one_label=pairing[1]) +
                      multi_a_value(data, zero_label=pairing[1], one_label=pairing[0])) / 2.0
